...
{
    [TestFixture]
    public class TC_Quan_Ly_Ve_Dat
    {
        ...
        //Qua thoi han huy ve
        [Test]
        public void TestCase_GDTC_TTCB1()
        {
            f.tb_user.Text = "cus1@gmail.com";
            f.tb_pass.Text = "1";
            f.btn_login_Click(null, null);
            fHomeUser.guna2Button3_Click(null, null);
            ...
            Thread.Sleep(4000);
            drive.FindElementByAccessibilityId("guna2Button3").Click();
            drive.FindElementByAccessibilityId("cbb_From").Click();
            WindowsElement haNoi = drive.FindElementByName("Hà Nội");
            actions.MoveToElement(haNoi).Click().Perform();
            drive.FindElementByAccessibilityId("cbb_To").Click();
            WindowsElement Hcm = drive.FindElementByName("Hà Nội");
            actions.MoveToElement(Hcm).Click().Perform();
            Thread.Sleep(2000);
           var a = drive.FindElementByAccessibilityId("date_Start");
